				...
				<div class="row">
					<div class="col-md-12">
						<div class="pagination">
							...
							<a href="/api_test/results1.php"><i class="glyphicon glyphicon-triangle-left"></i></a>
							<?php 
						...
						?>
							...
							<a href="/api_tetst/results3.php"><i class="glyphicon glyphicon-triangle-right"></i></a>
						</div>
					</div>
				</div>
			</div>
